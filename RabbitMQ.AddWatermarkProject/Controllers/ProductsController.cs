...
namespace RabbitMQ.AddWatermarkProject.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock,PictureUrl")] Product product, IFormFile ImageFile)
        {
            ...
            if(ImageFile.Length>0)
            {
                ...
                _rabbitMQPublisher.Publish(randomImageName);
                product.PictureUrl = randomImageName; //imagename halbuki ama ismini değiştirmek istemedim.
            }
